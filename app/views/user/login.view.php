...
<form class="row g-3 p-5" id="loginForm" action="" method="POST">
    <div class="d-flex justify-content-center"><h1 class="title">ĐĂNG NHẬP</h1></div>
  <div class="col-md-12">
  ...
  <div class="col-12">
    <a href="index.php?type=regis">Bạn chưa có tài khoản?</a>
    <br>
    <a href="index.php?type=resetpass">Bạn quên mật khẩu?</a>
  </div>
  <div class="col-12">

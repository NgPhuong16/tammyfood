                        ...
                        <div class="col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Đơn hàng đã phê duyệt có thể nhận</div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <form action="" method="post">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="take-order-btn">Nhận đơn</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Đơn hàng đã nhận</div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">

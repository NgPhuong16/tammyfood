...
<div class="content-wrapper-scroll">
							...
							<div class="col-sm-12 col-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Thêm quán</div>
									</div>
									<div class="card-body">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" value="" id="" name="nameCategory" required>
  </div>
  <div class="col-md-6">
    <label for="" class="form-label">Link ảnh quán:</label>
    <input type="text" class="form-control" value="" id="" name="imageCategory" required>
  </div>
  <div class="col-12">
    <button type="submit" class="btn btn-primary" name="add-shop-btn">Thêm</button>
  </div>
</form>
										</div>
										<!-- Row end -->

							...
							<div class="col-sm-12 col-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Danh sách quán ăn</div>
									</div>
									<div class="card-body">
												...
												<div class="product-card">
													...
													<div class="product-card-body">
														...
														<div class="product-actions">
															<a class="btn btn-success " href="index.php?type=shop&type1=fixshop&id='.$key['id_category'].'">Sửa</a>
															<a class="btn btn-danger " href="index.php?type=shop&del='.$key['id_category'].'">Xóa</a>
														</div>
													</div>
												</div>
											</div>

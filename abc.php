							...
							<div class="col-sm-12 col-12">
								<div class="card">
									<div class="card-header mb-5">
                                        <div class="card-title"><h6>Bây giờ hiện tại đang trong (<?php echo $getShiftNow['nameShift'];?>)</h6></div>
									</div>
                                    <div class="card-header mb-5">
										<div class="card-title">Đơn hàng (<?php echo $getShiftById['nameShift'];?>)-ngày <?php echo 'hôm nay: '.$currentDate->format('Y-m-d');  ?></div>
									</div>
										...
										<div class="table-responsive">
											<table class="table v-middle">
												...
												echo'
                                                    ...
                                                    ?>
												<tr>
												<th class="text-danger">Món</th>
												<th class="text-danger">Số lượng</th>
												<th class="text-danger">Giá</th>
											</tr>
													<?php
...
<table class="table table-primary table-striped table-bordered  v-middle"></table>